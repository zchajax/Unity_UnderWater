Shader "PostProcessing/FogEffect"
{
    Properties
    {
        ...
        _MaxVisualDistance ("Max Visual Distance", float) = 8
    }
    SubShader
    {
        // No culling or depth
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
                ...
                float maxVisualDistane = min(_ProjectionParams.z, _MaxVisualDistance);

                col = lerp(col, _FogColor, saturate(depth / max(1, maxVisualDistane)));
